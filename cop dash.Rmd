...
hamco_encounters <- read_csv("hamco encounters.csv")
...
admit_total <- admit_count(hamco_encounters, hamco_total)
...
admit_race <- hamco_encounters |>
  ...
  group_by(Race) |>
  mutate(
    denom = ifelse(Race == "Black", hamco_black, hamco_nonblack),
...
ed_total <- ed_count(hamco_encounters, hamco_total)
